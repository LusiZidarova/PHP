...
$priceEggsOneCozunak = $flour*0.75;
$priceMilkOneCozunak = ($flour*0.25 + $flour)*0.250;

$priceOneCozunak = $flour+$priceEggsOneCozunak+$priceMilkOneCozunak;

$coloredEggs = 0;
$countCozunac = 0;

while($budjet>$priceOneCozunak){

    $budjet=$budjet-$priceOneCozunak;
     $countCozunac++;
     $coloredEggs +=3;
     
     if($countCozunac % 3 == 0){
        $coloredEggs -= $countCozunac-2;
     }
}
$moneyLeft=number_format($budjet,2);
echo "You made ".$countCozunac." cozonacs! Now you have ".$coloredEggs." eggs and ".$moneyLeft."BGN left.";


/*
 * Problem 1. Easter Cozonacs // reshena ,no djudge ne priema stoinistite prawilno
