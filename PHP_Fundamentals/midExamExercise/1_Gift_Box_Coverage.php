...
$countThrees = floor($sheets / 3) ;
$restSheets = $sheets % 3;
$result = (($countThrees * 2.25) + $restSheets) * $cover;
$giftBox = $size *$size *6;
$percentage  =number_format(($result/$giftBox)*100,2) ;
echo 'You can cover '.$percentage.'% of the box.';
/*
Gift Box Coverage -Programming Fundamentals Mid Exam - 30 June 2019 Group 2 - 100%
Gift Box Coverage

Create a program that calculates what percentage you can cover of a 6-sided gift box (all sides are equal and square).
First, you will receive the size of a side. Also, you will receive the sheets of paper you have. Last, you will receive
how much area covers a single sheet of paper.
First, you need to calculate the area of the gift box. Then you have to calculate how much area you can cover with the
 paper available. Keep in mind that every third sheet covers only 25% of the usual area. You have to calculate what
percentage of the gift box you’ve covered. Percentage can exceed 100%!
...
Comments
The size of a side is 5. We have 6 sides, so the area is 5 * 5 * 6 = 150. 20 of sheets will cover 4 centimeters and 10 – 1 cm.
The total area covered is 90, which is 60% of the total area.
Input
2.5
32
4.25
